...
pub async fn aws_config(
    ...
    #[allow(deprecated)] // We'll bump BehaviorVersion the next time we bump tough.
    let mut config_loader = aws_config::defaults(BehaviorVersion::v2023_11_09()).retry_config(
